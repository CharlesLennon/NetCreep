        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen {{getSetting('style.main-class')}}">
            ...
            <div class="fixed top-0 right-0 p-2 z-50 flex items-center gap-2">
                ...
                @if(asset('images/logo.png'))
                    <a href="" class="inline-block {{getSetting('style.alt-class')}} text-white rounded-full p-1 hover:bg-gray-700">
